...
class Converter:
    def __init__(self):
        ...
        self.temp_instructions_label = Label(self.converter_frame, text="Type in the amount to be " "converted and then push " "one of the buttons below...",
        ...
        self.to_convert_entry.grid(row=2, pady=10)
